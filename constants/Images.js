// local imgs
const Onboarding = require("../assets/imgs/trianguloz.png");
...
const equilateral = require("../assets/imgs/equilateral.png");
const isosceles = require("../assets/imgs/Isosceles.png");
const scalene = require("../assets/imgs/scalene.png");
const confusedCat = require("../assets/imgs/cat.jpg");
// internet imgs
...
const Products = {
  ...
  'mit': 'http://ranking.jagranjosh.com/upload/1554436322MIT%20ADT%20building.jpg'
};
